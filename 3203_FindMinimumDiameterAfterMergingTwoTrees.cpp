//question: https://leetcode.com/problems/find-minimum-diameter-after-merging-two-trees/
...
public:
    int minimumDiameterAfterMerge(vector<vector<int>>& edges1,
        ...
        int diameter1 = findDiameter(n, adjList1), diameter2 = findDiameter(m, adjList2);
...
private:
    ...
    int findDiameter(int n, vector<vector<int>>& adjList) {
        ...
        int remainingNodes = n, leavesLayersRemoved = 0;
